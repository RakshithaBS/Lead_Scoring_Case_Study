...
##############################################################################
def interactions_mapping(db_file_name,db_path,interaction_mapping_file,index_columns):
    '''
...
def get_processed_data(db_path,db_file_name):
    ...
    interactions_mapping(db_file_name,db_path,INTERACTION_MAPPING,INDEX_COLUMNS)
